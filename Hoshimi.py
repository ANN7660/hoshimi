...
# Cette version désactive les fonctions audio/voix de discord.py
import sys
sys.modules['discord.voice_client'] = None
sys.modules['discord.player'] = None
sys.modules['discord.voice_state'] = None
print('🚫 Module audio désactivé pour compatibilité Python 3.13')
