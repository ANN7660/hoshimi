# === Version sans audio (compatibilité Python 3.13) ===
# Ce patch crée de faux modules audio pour empêcher Discord.py de planter.
import sys, types

fake_voice = types.ModuleType("discord.voice_client")
fake_player = types.ModuleType("discord.player")
fake_audio = types.ModuleType("discord.audio")
sys.modules["discord.voice_client"] = fake_voice
sys.modules["discord.player"] = fake_player
sys.modules["discord.audio"] = fake_audio

print("🚫 Modules audio désactivés (mode sans audio activé pour compatibilité Python 3.13)\n")
